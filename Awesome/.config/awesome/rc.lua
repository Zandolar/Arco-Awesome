...
local settings          = "systemsettings5"
...
globalkeys = my_table.join(
    ...
    -- super + ...
   -- awful.key({ modkey }, "c", function () awful.util.spawn( settings ) end,
    --    {description = settings, group = "super"}),
    awful.key({ modkey }, "o", function () awful.util.spawn( virtualmachine ) end,
        {description = virtualmachine, group = "super"}),
    awful.key({ modkey, altkey }, "m", function () awful.util.spawn( mailclient ) end,
        {description = mailclient, group = "super"}),
    awful.key({ modkey, altkey }, "Enter", function () awful.util.spawn( "xterm" ) end,
        {description = "xterm", group = "super"}),        
    awful.key({ modkey }, "c", function () awful.util.spawn( mediaplayer ) end,
        {description = mediaplayer, group = "super"}),
    awful.key({ modkey, altkey }, "c", function () awful.util.spawn( "plex-desktop" ) end,
        {description = "jellyfin", group = "super"}),
    awful.key({ modkey }, "g", function () awful.util.spawn( "gimp" ) end,
        {description = "gimp", group = "super"}),
    awful.key({ modkey }, "p", function () awful.util.spawn( "/home/matt/ethtool.sh" ) end,
        {description = "ethtool.sh", group = "super"}),
    awful.key({ modkey }, "e", function () awful.util.spawn( editorgui ) end,
        {description = "run gui editor", group = "super"}),
    awful.key({ modkey, altkey   }, "t", function() awful.util.spawn( "archlinux-tweak-tool" ) end,
    ...
    awful.key({ modkey1, altkey   }, "e", function() awful.util.spawn("catfish") end,
...
awful.rules.rules = {
    ...
    -- Set applications to always map on the tag 10 on screen 1.
       ...
       { rule = { class = "whatsapp-nativefier-d40211" },                      
          properties = { screen = 1, tag = awful.util.tagnames[10], switchtotag = true  } },          

    -- Set applications to always map on the tag 11 on screen 1.

       { rule = { class = "VirtualBox Manager" },                      
          properties = { screen = 1, tag = awful.util.tagnames[11], switchtotag = true  } },
    ...
    -- Set applications to always map on the tag 12 on screen 1.

       { rule = { class = "Vncviewer" },                      
          properties = { screen = 1, tag = awful.util.tagnames[12], switchtotag = false  } },          
    

    -- Set applications to always map on the tag 13 on screen 1.

       { rule = { class = "Nicotine" },                      
          properties = { screen = 1, tag = awful.util.tagnames[13], switchtotag = true  } },

       { rule = { class = "Transmission-gtk" },                      
          properties = { screen = 1, tag = awful.util.tagnames[13], switchtotag = true  } },
        
    -- Set applications to always map on the tag 14 on screen 1.

       { rule = { class = "Clementine" },                      
          properties = { screen = 1, tag = awful.util.tagnames[14], switchtotag = true  } },    
    
    -- Set applications to always map on the tag 15 on screen 1.

       { rule = { class = "Brave-browser" },                      
          properties = { screen = 1, tag = awful.util.tagnames[15], switchtotag = true  } },

    -- Set applications to always map on the tag 16 on screen 1.    

       { rule = { class = "Plex" },                      
          properties = { screen = 1, tag = awful.util.tagnames[16], switchtotag = true  } },
...
awful.spawn.once("flatpak run com.github.debauchee.barrier")
