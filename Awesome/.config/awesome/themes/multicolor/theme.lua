...
local mytextclock = wibox.widget.textclock(markup("#de5e1e", "%A %d %B ") .. markup("#fc7d3d", "-") .. markup("#de5e1e", " %H:%M "))
...
theme.volume = lain.widget.alsa({
    settings = function()
        ...
        widget:set_markup(markup.fontfg(theme.font, "#de5e1e", volume_now.level .. "% "))
    end
})
